  ...
  const duoTypes = [
    {
      ...
      count: "5–8 баллов ",
      yourDuo: "Творцы",
      desc: "Вы — творческий дуэт, который любит создавать что-то своими руками: лепить, мастерить и придумывать блюда. Совместные игры и поделки развивают мелкую моторику и воображение ребенка, а обычный ужин превращается в яркую арт-сессию. Вместе вы с радостью готовите и украшаете пиццу, делаете фигурки из Play-Doh и обсуждаете свои идеи. Такой подход делает семейное время веселым и сближает вас как команду.",
    },
    {
      id: 2,
      count: "8–12 баллов",
      yourDuo: "Исследователи",
      desc: "Вы — самая любознательная пара мамы и ребенка, которой интересно узнавать новое. Вместе вы читаете энциклопедии и книги о животных, гуляете по парку и изучаете окружающий мир. Наше детское комбо Play Dodo поможет ближе узнать животных из Красной книги Казахстана — каждый набор содержит карточку с новым видом. Такие занятия расширяют кругозор ребенка и прививают заботу о природе.",
    },
    {
      id: 3,
      count: "12–15 баллов",
      yourDuo: "Гурманы",
      desc: "Вы — то самое дуо, которое любит вкусно поесть и приготовить что-то вместе. Вы исследуете рецепты, устраиваете домашние пицца-вечеринки и делитесь друг с другом впечатлениями о добавленных специях. Регулярные семейные ужины полезны для здоровья и настроения детей. ",
    },
  ];
