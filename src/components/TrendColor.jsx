...
export function TrendColor() {
  ...
  const recipeList = [
    {
      id: 1,
      headText: "Трендовые цвета",
      desc: "В 2025 пользуются популярностью следующие оттенки:",
      desc2: ["Мягкий коралловый", "Оливковый шалфей", "Раковина моллюска"],
      text: "Добавьте трендовый оттенок через текстиль и посуду. Это моментально обновит вид стола.",
    },
    {
      id: 2,
      headText: "Правило трех",
      desc: "Расставляйте декоративные элементы «правилом трех». Например:",
      desc2: ["Стопка книг", "Декоративная свеча", "Маленькая ваза с цветком"],
      text: "Так композиция будет выглядеть сбалансированной.",
    },
    {
      id: 3,
      headText: "Kid-friendly декор",
      desc: "Разместите на столе безопасные игры и декоративные элементы:",
      desc2: [
        "Деревянные кубики, пазлы, магнитные наборы (особенно увлекают детей)",
        "Фактурные детали: кисточки, ракушки, деревянные бусины",
      ],
  ...
  return (
    <div id="trend" className="min-h-screen  mt-30  max-sm:mt-15">
      <div className="flex items-center justify-around max-sm:flex-col max-sm:gap-10 h-full">
        <div
        ...
        >
          ...
          <div className=" trend-card absolute top-0 -left-3 -rotate-2 w-[394px] max-sm:w-[270px]   mx-auto bg-white rounded-3xl shadow-xl p-4">
            <div className="overflow-hidden rounded-2xl">
              <img
                src="/trend2.webp"
                alt="Card"
